...
def main():
    ...
    attachment_id = siemplify.extract_action_param("Attachment ID", print_value=True)
    ...
    message_attachment_data = mtm.delete_attachment(
        user_email,
        message_id,
        attachment_id,
    )
    ...
    output_message = message_attachment_data["output_message"]
    result_value = message_attachment_data["result"]
