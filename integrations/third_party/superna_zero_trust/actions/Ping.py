...
def main():
    ...
    apicall = url + eyeglassip + apiroute
    ...
    response = None
    try:
        response = requests.get(apicall, headers=headers, timeout=30, verify=verify_ssl)
