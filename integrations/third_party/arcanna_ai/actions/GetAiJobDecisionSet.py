...
from ..core.constants import GET_DECISION_SET_SCRIPT_NAME


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = GET_DECISION_SET_SCRIPT_NAME
    ...
    try:
        ...
        response_json = client.get_job_decision_set(job_id)
        output_message = (
