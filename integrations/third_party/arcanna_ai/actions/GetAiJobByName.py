...
from ..core.constants import GET_JOB_BY_NAME_SCRIPT_NAME


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = GET_JOB_BY_NAME_SCRIPT_NAME
    ...
    job_name = str(
        siemplify.extract_action_param("Job name", print_value=True, is_mandatory=True),
    )
    ...
    try:
        ...
        response_json = client.get_job_by_name(job_name)
        output_message = (
