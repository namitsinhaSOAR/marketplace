...
from ..core.constants import GET_DECISION_SET_BY_JOB_NAME_SCRIPT_NAME


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = GET_DECISION_SET_BY_JOB_NAME_SCRIPT_NAME
    ...
    job_name = siemplify.extract_action_param(
        "Job name",
        print_value=True,
        is_mandatory=True,
    )
    ...
    try:
        ...
        response_json = client.get_job_decision_set_by_name(job_name)
        output_message = (
