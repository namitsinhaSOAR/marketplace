...
from ..core.constants import EXPORT_EVENT_SCRIPT_NAME
...
def main():
    ...
    siemplify.script_name = EXPORT_EVENT_SCRIPT_NAME
    ...
    try:
        ...
        response_json = client.export_event(job_id=job_id, event_id=event_id)
        output_message = (
